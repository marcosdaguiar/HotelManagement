...
export const AvailabilityList = ({listOfRooms, setListOfRooms}) => {
            ...
            <tbody>
                {listOfRooms.map((value, index) => (
                    <React.Fragment key = {index}>
                        <tr>
                            <td width="100px">{value.room_id}</td>
                            <td width="140px">{value.room_type}</td>
                            <td width="100px">{value.room_bed_count}</td>
                            <td width="100px">{value.room_bed_size}</td>
                            ...
                            <td width="80px">${value.room_price}</td>
                            <td>                         
